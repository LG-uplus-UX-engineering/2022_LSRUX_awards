...
const Guide4 = '지원서 접수는 LG Careers <a href="https://careers.lg.com/app/job/RetrieveJobNoticesDetail.rpi?jobNoticeId=396799" target="_blank"><span>https://careers.lg.com</span></a>를 통해 제출해주시고, 그 외 공모전 출품은 LSR/UX 공모전 공용계정 이메일 <span class="email_address">lsruxawards@lguplus.co.kr</span>로 제출해주시기 바랍니다.';
...
var data_description = {
    'UX_RESEARCH' : {
      ...
      'SUBJECT': {
        ...
        2 : {NUM:'2.', TEXT:'[접점] 통신사 고객 여정에 따른 LG유플러스 접점의 고객경험 방향 혹은 UX 방향 제안', SUB:'접점 범위 : U+기존 접점(U+매장, U+홈페이지, U+언택트스토어, 당신의 U+(고객센터)등), 신규접점<br>고객경험 방향 : 고객 여정 조사/분석 기반의 접점 경험 개선 및 신규 접점 경험 전략 방향<br>UX 방향 : UX 리서치 기반의 접점 서비스 UX개선 및 신규 UX 방향성'},
      ...
      'DETAIL': {
        0 : {NUM:'',TEXT:'선택한 주제를 해결하기 위해 최적의 리서치 방법을 설계/실행하고, 이를 기반으로 고객의 행동 패턴을 파악/분석함으로써 UX 전략과 고객 경험 방향 수립'},
      },
      'GUIDE' : {
        0 : {NUM:'1.', TEXT:Guide1},
        1 : {NUM:'2.', TEXT:Guide2},
        2 : {NUM:'3.', TEXT:'원칙적으로 화면의 분량은 제한이 없으나 가급적 15페이지 이내로 작성할 것을 권장함'},
        3 : {NUM:'4.', TEXT:Guide4},
        4 : {NUM:'5.', TEXT:Guide5},
