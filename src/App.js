          ...
          <div className="total_wrapper">
              <section className="gnb">
                  <div className="gnb_wrapper">
                      ...
                      <ul>
                          <li className="scrollable" data-scroll="1">공모 분야</li>
                          <li className="scrollable" data-scroll="2">수상 특전</li>
                          <li className="scrollable" data-scroll="3">진행 절차</li>
                          <li className="scrollable" data-scroll="4">QnA</li>
                      </ul>
                  </div>
              </section>
              <article className="default">
                  <section className="banner banner_mobile">
                      <div className="img_wrapper">
                          <img src="/img/img_banner_mobile_3.png" alt="" className="img_mobile_banner"></img>
                      </div>
                  ...
                  <section className="banner swiper-container">
                      <div className="swiper-wrapper">
                          <div className="img_wrapper swiper-slide">
                              <img src="img/img-banner-main_2021_new.png" />
                          </div>
                          <div className="img_wrapper swiper-slide type3">
                              <img src="img/img-banner-01_2021.png" />
                              <a className="btn-interview" href="http://meet.lg.com/learn/introducejob/IntroduceJobDetail.rmi?requestIntroId=382" target="_blank"><span>인터뷰 보러가기</span></a>
                          </div>
                          <div className="img_wrapper swiper-slide type1">
                              <img src="img/img-banner-03_2021.png" />
                              <a className="btn-interview" href="http://meet.lg.com/learn/introducejob/IntroduceJobDetail.rmi?requestIntroId=297" target="_blank"><span>인터뷰 보러가기</span></a>
                          </div>
                          <div className="img_wrapper swiper-slide type2">
                              <img src="img/img-banner-02_2021.png" />
                              <a className="btn-interview" href="http://meet.lg.com/learn/introducejob/IntroduceJobDetail.rmi?requestIntroId=383" target="_blank"><span>인터뷰 보러가기</span></a>
                          </div>
                      </div>
                  ...
                  <section className="content content__a">
                      <div className="content_wrapper">
                          <div className="title gmarketsans">모집기간</div>
                          <div className="desc">
                              <p>8월 30일(월) 부터 9월 22일(수) 23:00시까지</p>
                          </div>
                      </div>
                      <div className="content_wrapper">
                          <div className="title gmarketsans">모집대상</div>
                          <div className="desc">
                      ...
                      <div className="content_wrapper" id="scroll_1">
                          <div className="title gmarketsans">공모분야</div>
                          <div className="desc">
                  ...
                  <section className="content content__b">
                      <div className="case case__1 active" data-case="UX_RESEARCH">
                          ...
                          <span className="btn_case gmarketsans">UX리서치 및 전략</span>
                          <span className="hello gmarketsans">Hello</span>
                      </div>
                      <div className="case case__2" data-case="UI_PLAN">
                          {/* <img src="/img/btn-part-01@2x.png" alt=""> */}
                          <span className="btn_case gmarketsans">UI기획 및 설계</span>
                          <span className="hello gmarketsans">Hello</span>
                      </div>
                      <div className="case case__3" data-case="GUI_DESIGN">
                          {/* <img src="/img/btn-part-01@2x.png" alt=""> */}
                          <span className="btn_case gmarketsans">GUI 디자인</span>
                          <span className="hello gmarketsans">Hello</span>
                      </div>
                      <div className="case case__4" data-case="UX_PROTOTYPE">
                          {/* <img src="/img/btn-part-01@2x.png" alt=""> */}
                          <span className="btn_case gmarketsans">UX 프로토타이핑</span>
                          <span className="hello gmarketsans">Hello</span>
                      </div>
                  </section>
                  ...
                  <section className="content content__c">
                      <div className="content_wrapper" id="scroll_2">
                          <div className="title gmarketsans">수상특전</div>
                          <div className="desc">
                          ...
                          <div className="detail_wrapper">
                              <div className="detail">
                                  <div>
                                      <span className="gmarketsans">Gold(4인)</span><span></span><span className="gmarketsans">상금 100만원 및 상장</span>
                                  </div>
                                  <div>
                                      <span className="gmarketsans">Silver(4인)</span><span></span><span className="gmarketsans">상금 50만원 및 상장</span>
                                  </div>
                                  <div>
                                      <span className="gmarketsans">Bronze(8인)</span><span></span><span className="gmarketsans">상금 30만원 및 상장</span>
                                  </div>
                              </div>
                  ...
                  <section className="content content__d">
                      <div className="content_wrapper" id="scroll_3">
                          <div className="title gmarketsans">진행절차</div>
                          <div className="desc">
                              <p>하기 일정은 상황에 따라 변경될 수 있으며, 각 전형 별 상세 일정은 합격자에게 개별 통보됩니다.</p>
                          </div>
                          <div className="process">
                              <div className="step">
                                  <div className="date gmarketsans"><span className="gmarketsans">9월 28일</span></div>
                                  <div className="text gmarketsans">수상작발표</div>
                              </div>
                              <div className="step step_line"></div>
                              <div className="step">
                                  <div className="date gmarketsans"><span className="gmarketsans">10월 5일</span></div>
                                  <div className="text gmarketsans">시상식 진행</div>
                              </div>
                              <div className="step step_line"></div>
                              <div className="step">
                                  <div className="date gmarketsans"><span className="gmarketsans">10월 중</span></div>
                                  <div className="text gmarketsans">인적성검사 & AI영상 면접</div>
                              </div>
                              <div className="step step_line"></div>
                              <div className="step">
                                  <div className="date gmarketsans"><span className="gmarketsans">10월 중</span></div>
                                  <div className="text gmarketsans">실무 면접</div>
                              </div>
                              <div className="step step_line"></div>
                              <div className="step no_shrink">
                                  <div className="date gmarketsans"><span className="gmarketsans">10월 ~ 11월중</span></div>
                                  <div className="text gmarketsans">인턴십(4주)</div>
                              </div>
                              <div className="step step_line"></div>
                              <div className="step">
                                  <div className="date gmarketsans"><span className="gmarketsans">11월 중</span></div>
                                  <div className="text gmarketsans">임원 면접</div>
                              </div>
                              <div className="step step_line"></div>
                              <div className="step">
                                  <div className="date date_final gmarketsans"><span className="gmarketsans">22년 1/1</span></div>
                                  <div className="text gmarketsans">입사</div>
                              </div>
                          </div>
                      </div>
                  </section>
              ...
              <article className="qna">
                  <section className="content content__e" id="scroll_4">
                      <div className="content_wrapper">
                          <div className="title gmarketsans">자주 묻는 질문</div>
                          <div className="desc">
                          ...
                          <div className="wrapper_qna_case">
                              <div className="case_qna">
                                  <p className="question"><span className="gmarketsans">Q1.</span><span className="gmarketsans">공모전 접수는 어디로 하면 되나요?</span></p>
                                  <p className="answer">
                              ...
                              <div className="case_qna">
                                  <p className="question"><span className="gmarketsans">Q2.</span><span className="gmarketsans">다른 이메일 계정으로 여러 공모분야에 중복 지원이 가능한가요?</span></p>
                                  <p className="answer">
                              ...
                              <div className="case_qna">
                                  <p className="question"><span className="gmarketsans">Q3.</span><span className="gmarketsans">저는 석사인데, 지원 가능한가요?</span></p>
                                  <p className="answer">
                                      석사 전공자도 지원 가능하나, 경력 2년 미만일 경우에만 지원 가능합니다.
                                  </p>
                              </div>
                              <div className="case_qna">
                                  <p className="question"><span className="gmarketsans">Q4.</span><span className="gmarketsans">과거에 불합격한 사람이 다시 지원해도 되나요?</span></p>
                                  <p className="answer">
                                      과거 지원 이력에 따른 별도의 제한은 없어, 지원 가능합니다.
                                  </p>
                              </div>
                              <div className="case_qna">
                                  <p className="question"><span className="gmarketsans">Q5.</span><span className="gmarketsans">지원 시 성별 및 연령제한이 있나요?</span></p>
                                  <p className="answer">
                                      LG유플러스는 지원시 성별 및 연령 제한을 두지 않고 있습니다.
                                  </p>
                              </div>
                              <div className="case_qna">
                                  <p className="question"><span className="gmarketsans">Q6.</span><span className="gmarketsans">작품제출을 이미 했는데 수정 가능한가요?</span></p>
                                  <p className="answer">
                              ...
                              <div className="case_qna">
                                  <p className="question"><span className="gmarketsans">Q7.</span><span className="gmarketsans">각 직무 별 어떤 업무를 하는 지 구체적으로 알고 싶어요.</span></p>
                                  <p className="answer">
                              ...
                              <div className="case_qna">
                                  <p className="question"><span className="gmarketsans">Q8.</span><span className="gmarketsans">유플러스가 현재 진행하는 산업군을 고려하여 과제를 수행해야 하나요?</span></p>
                                  <p className="answer">
                  ...
                  <section className="apply">
                      <a className="btn btn__apply no_underline" href="http://apply.lg.com/app/job/RetrieveJobNotices.rpi?sCompanyCode=LGT" target="_blank">
                          <span className="gmarketsans">지원하기</span>
                      </a>
