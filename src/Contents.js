...
const ContentArray6 = [
    ...
    {num: 'Q7. ', title: '각 직무 별 어떤 업무를 하는 지 구체적으로 알고 싶어요.', answer:['LG Careers의 People 페이지에는 LG의 주요 직무 소개, 조직 분위기, 선배 사원 이야기, 조직 문화 등과 관련된 자료들이 모아져 있습니다. LG People를 통해 내가 가고 싶은 회사를 미리 경험해보세요. 홈 화면의 배너를 통해서 해당 페이지로 바로 이동이 가능합니다.']},
